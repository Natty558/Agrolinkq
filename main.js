...
const PRODUCTS = [
  { id: 1, name: 'Fresh Tomatoes', category: 'Vegetables', price: 15, unit: 'kg', stock: 120, seller: 'Asaase Farms', rating: 4.8, img: 18152320, region: 'Eastern', desc: 'Freshly harvested tomatoes grown in the rich soils of the Eastern Region.' },
  { id: 2, name: 'Maize (Dried)', category: 'Grains', price: 8, unit: 'bag (50kg)', stock: 200, seller: 'Kofi Farms', rating: 4.6, img: 10112728, region: 'Ashanti', desc: 'Quality dried maize from the Ashanti Region. Great for milling and kenkey.' },
  { id: 3, name: 'Free-Range Eggs', category: 'Poultry', price: 30, unit: 'crate', stock: 80, seller: 'Akua Poultry', rating: 4.9, img: 32450944, region: 'Central', desc: 'Farm-fresh free-range eggs from healthy hens in the Central Region.' },
  { id: 4, name: 'Pure Honey', category: 'Specialty', price: 80, unit: 'jar (500ml)', stock: 50, seller: 'Ananse Apiary', rating: 5.0, img: 5634212, region: 'Brong-Ahafo', desc: 'Pure, raw honey from the Brong-Ahafo Region. No additives.' },
  { id: 5, name: 'Fresh Spinach', category: 'Vegetables', price: 10, unit: 'bunch', stock: 90, seller: 'Asaase Farms', rating: 4.5, img: 30801724, region: 'Eastern', desc: 'Crisp, tender spinach leaves (kontomire). Washed and ready to cook.' },
  { id: 6, name: 'Ripe Plantain', category: 'Fruits', price: 12, unit: 'bunch', stock: 150, seller: 'Nana Farms', rating: 4.7, img: 35136066, region: 'Western', desc: 'Sweet ripe plantains from the Western Region. Perfect for kelewele.' },
  { id: 7, name: 'Local Rice', category: 'Grains', price: 25, unit: 'bag (25kg)', stock: 70, seller: 'Volta Rice Mills', rating: 4.4, img: 3737694, region: 'Volta', desc: 'Premium local rice from the Volta Region. Stone-free and aromatic.' },
  { id: 8, name: 'Fresh Milk', category: 'Dairy', price: 20, unit: 'liter', stock: 100, seller: 'Akua Poultry', rating: 4.8, img: 5946742, region: 'Eastern', desc: 'Fresh, pasteurized whole milk from grass-fed cows in the Eastern Region.' },
  { id: 9, name: 'Green Pepper', category: 'Vegetables', price: 18, unit: 'kg', stock: 60, seller: 'Kofi Farms', rating: 4.3, img: 9394683, region: 'Ashanti', desc: 'Crisp green bell peppers, great for stews, stir-fries, and salads.' },
  { id: 10, name: 'Watermelon', category: 'Fruits', price: 15, unit: 'piece', stock: 40, seller: 'Nana Farms', rating: 4.9, img: 128598, region: 'Northern', desc: 'Sweet, juicy watermelons from the Northern Region.' },
  { id: 11, name: 'Yam (Pona)', category: 'Tubers', price: 20, unit: 'tuber', stock: 110, seller: 'Savannah Farms', rating: 4.5, img: 7543152, region: 'Northern', desc: 'Premium Pona yam from the Northern Region. Perfect for fufu.' },
  { id: 12, name: 'Smoked Fish', category: 'Specialty', price: 35, unit: 'kg', stock: 30, seller: 'Ananse Apiary', rating: 4.7, img: 11932015, region: 'Volta', desc: 'Quality smoked tilapia from Lake Volta. Ready for soups and stews.' },
  { id: 13, name: 'Red Onions', category: 'Vegetables', price: 14, unit: 'kg', stock: 85, seller: 'Savannah Farms', rating: 4.4, img: 7890176, region: 'Northern', desc: 'Pungent red onions from the Northern Region. Essential for Ghanaian cooking.' },
  { id: 14, name: 'Cassava', category: 'Tubers', price: 6, unit: 'kg', stock: 180, seller: 'Asaase Farms', rating: 4.2, img: 7543161, region: 'Eastern', desc: 'Fresh cassava roots. Perfect for gari, fufu, and banku.' },
  { id: 15, name: 'Groundnuts (Dried)', category: 'Grains', price: 22, unit: 'bag (25kg)', stock: 60, seller: 'Kofi Farms', rating: 4.6, img: 33501329, region: 'Ashanti', desc: 'Premium dried groundnuts from the Ashanti Region. Great for peanut butter and kuli-kuli.' },
  { id: 16, name: 'Fresh Okra', category: 'Vegetables', price: 12, unit: 'kg', stock: 70, seller: 'Nana Farms', rating: 4.5, img: 671963, region: 'Western', desc: 'Tender fresh okra pods. Perfect for okro soup and stews.' },
  { id: 17, name: 'Pineapple', category: 'Fruits', price: 10, unit: 'piece', stock: 95, seller: 'Volta Farms', rating: 4.8, img: 6157064, region: 'Volta', desc: 'Sweet, juicy pineapples from the Volta Region. Naturally ripened.' },
  { id: 18, name: 'Sorghum', category: 'Grains', price: 18, unit: 'bag (50kg)', stock: 45, seller: 'Savannah Farms', rating: 4.3, img: 13867829, region: 'Upper East', desc: 'Drought-resistant sorghum from the Upper East Region. Ideal for brewing and livestock feed.' },
  { id: 19, name: 'Fresh Tilapia', category: 'Specialty', price: 40, unit: 'kg', stock: 55, seller: 'Volta Fishery', rating: 4.9, img: 8352786, region: 'Volta', desc: 'Fresh tilapia from Lake Volta. Cleaned, scaled, and ready to cook.' },
  { id: 20, name: 'Cocoyam', category: 'Tubers', price: 8, unit: 'kg', stock: 100, seller: 'Asaase Farms', rating: 4.4, img: 9217362, region: 'Eastern', desc: 'Fresh cocoyam from the Eastern Region. Great for cocoyam chips and kontomire.' },
  { id: 21, name: 'Mango (Keitt)', category: 'Fruits', price: 18, unit: 'kg', stock: 75, seller: 'Nana Farms', rating: 4.7, img: 8523870, region: 'Western', desc: 'Sweet Keitt mangoes from the Western Region. Juicy and fiberless.' },
  { id: 22, name: 'Cowpeas (Beans)', category: 'Grains', price: 20, unit: 'bag (50kg)', stock: 65, seller: 'Savannah Farms', rating: 4.5, img: 36285397, region: 'Northern', desc: 'Quality cowpeas from the Northern Region. Rich in protein for waakye and gari beans.' },
  { id: 23, name: 'Garden Eggs', category: 'Vegetables', price: 16, unit: 'kg', stock: 50, seller: 'Kofi Farms', rating: 4.2, img: 28930670, region: 'Ashanti', desc: 'Fresh garden eggs (African eggplant). Perfect for stews and garden egg sauce.' },
  { id: 24, name: 'Palm Oil (Pure)', category: 'Specialty', price: 45, unit: 'liter', stock: 40, seller: 'Volta Farms', rating: 4.8, img: 9814620, region: 'Volta', desc: 'Pure, unadulterated red palm oil from the Volta Region. Rich in vitamins.' },
  { id: 25, name: 'Cabbage', category: 'Vegetables', price: 14, unit: 'head', stock: 80, seller: 'Asaase Farms', rating: 4.3, img: 6316536, region: 'Eastern', desc: 'Crisp, fresh cabbage heads. Great for salads, slaws, and stews.' },
  { id: 26, name: 'Soybeans', category: 'Grains', price: 28, unit: 'bag (50kg)', stock: 55, seller: 'Savannah Farms', rating: 4.6, img: 4518579, region: 'Upper West', desc: 'High-quality soybeans from the Upper West Region. Perfect for dawadawa and soy milk.' },
  { id: 27, name: 'Bananas (Red)', category: 'Fruits', price: 8, unit: 'bunch', stock: 120, seller: 'Nana Farms', rating: 4.7, img: 61127, region: 'Western', desc: 'Sweet red bananas from the Western Region. Naturally ripened on the farm.' },
  { id: 28, name: 'Fresh Pepper (Red)', category: 'Vegetables', price: 25, unit: 'kg', stock: 45, seller: 'Kofi Farms', rating: 4.5, img: 4142392, region: 'Ashanti', desc: 'Hot red chili peppers from the Ashanti Region. Fire for shito and pepper sauce.' },
  { id: 29, name: 'Coconut', category: 'Fruits', price: 5, unit: 'piece', stock: 200, seller: 'Volta Farms', rating: 4.6, img: 7543123, region: 'Volta', desc: 'Fresh coconuts from the Volta Region. Sweet water and rich meat.' },
  { id: 30, name: 'Gari (Fine)', category: 'Specialty', price: 15, unit: 'kg', stock: 150, seller: 'Asaase Farms', rating: 4.4, img: 8477743, region: 'Eastern', desc: 'Fine, crispy gari from the Eastern Region. Perfect for gari soakings and gari foto.' },
];
...
(function seedData() {
  if (!localStorage.getItem('agri_seeded_v2')) {
    ...
    saveStore('agri_notifications', [
      ...
      { id: 3004, type: 'success', title: 'Payment Received', message: 'GHS 450 received from Asaase Farms order', date: '2025-01-18', read: true },
...
function detectLocation(callback) {
  if (!navigator.geolocation) { toast('Geolocation is not supported by your browser'); return; }
  ...
  navigator.geolocation.getCurrentPosition(
    ...
    (err) => { toast('Could not detect your location. Please select your region manually.'); },
